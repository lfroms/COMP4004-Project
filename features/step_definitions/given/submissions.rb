...
Given('a student with email {string} has created a submission {string} for deliverable {string} for course offering {string} section {string}') do |email, attachment_url, title, code, section|
