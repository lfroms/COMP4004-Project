...
class TermTest < ActiveSupport::TestCase
  test 'term can be created with all fields present' do
    term = Term.new(
      start_date: DateTime.new(2020, 9, 1, 4, 5, 6),
      end_date: DateTime.new(2020, 12, 15, 4, 5, 6),
      registration_deadline: DateTime.new(2020, 9, 1, 4, 5, 6),
      withdrawal_deadline: DateTime.new(2020, 10, 1, 4, 5, 6),
      financial_deadline: DateTime.new(2020, 9, 30, 4, 5, 6),
    )
  ...
  test 'term cannot be created if end_date is before start_date' do
    term = Term.new(
      start_date: DateTime.new(2020, 12, 15, 4, 5, 6),
      end_date: DateTime.new(2020, 9, 1, 4, 5, 6),
      registration_deadline: DateTime.new(2020, 9, 1, 4, 5, 6),
      withdrawal_deadline: DateTime.new(2020, 10, 1, 4, 5, 6),
      financial_deadline: DateTime.new(2020, 9, 30, 4, 5, 6),
    )
  ...
  test 'term cannot be created if withdrawal deadline is outside the bounds of the term' do
    term = Term.new(
      ...
      end_date: DateTime.new(2020, 9, 1, 4, 5, 6),
      registration_deadline: DateTime.new(2020, 9, 1, 4, 5, 6),
      withdrawal_deadline: DateTime.new(2020, 8, 1, 4, 5, 6),
      financial_deadline: DateTime.new(2020, 9, 30, 4, 5, 6),
    )
  ...
  test 'term cannot be created if financial_deadline is outside the bounds of the term' do
    term = Term.new(
      ...
      registration_deadline: DateTime.new(2020, 9, 1, 4, 5, 6),
      withdrawal_deadline: DateTime.new(2020, 10, 1, 4, 5, 6),
      financial_deadline: DateTime.new(2020, 8, 30, 4, 5, 6),
    )
